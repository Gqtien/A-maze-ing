...
# Initialisation
  def mlx_init(self):  # type: ignore
    self.mlx_func.mlx_init.restype = c_void_p
    return self.mlx_func.mlx_init()

  def mlx_release(self, mlx_ptr):  # type: ignore
...
# Windows
  def mlx_new_window(self, mlx_ptr, width, height, title):  # type: ignore
  ...
  def mlx_clear_window(self, mlx_ptr, win_ptr):  # type: ignore
  ...
  def mlx_pixel_put(self, mlx_ptr, win_ptr, x, y, color):  # type: ignore
  ...
  def mlx_destroy_window(self, mlx_ptr, win_ptr):  # type: ignore
...
# Images
  def mlx_new_image(self, mlx_ptr, width, height):  # type: ignore
...
# API break, returns tuple
  def mlx_get_data_addr(self, img_ptr):  # type: ignore
  ...
  def mlx_put_image_to_window(self, mlx_ptr, win_ptr, img_ptr, x, y):  # type: ignore
  ...
  def mlx_destroy_image(self, mlx_ptr, img_ptr):  # type: ignore
...
#  Use C^-\ to kill your program.
  ...
  def mlx_mouse_hook(self, win_ptr, callback, param):  # type: ignore
  ...
  def mlx_key_hook(self, win_ptr, callback, param):  # type: ignore
  ...
  def mlx_expose_hook(self, win_ptr, callback, param):  # type: ignore
  ...
  def mlx_loop_hook(self, mlx_ptr, callback, param):  # type: ignore
  ...
  def mlx_hook(self, win_ptr, x_event, x_mask, callback, param):  # type: ignore
    x_event_key = [2, 3]
    x_event_mouse = [4, 5]
    x_event_motion = [6]
...
# Misc.
  ...
  def mlx_string_put(self, mlx_ptr, win_ptr, x, y, color, string):  # type: ignore
...
# API break, returns tuple
  def mlx_xpm_file_to_image(self, mlx_ptr, filename):  # type: ignore
    width = c_uint()
    height = c_uint()
...
# API break, returns tuple
  def mlx_png_file_to_image(self, mlx_ptr, filename):  # type: ignore
    width = c_uint()
    height = c_uint()
...
#			  unsigned int *width, unsigned int *height);
  ...
  def mlx_mouse_hide(self, mlx_ptr):  # type: ignore
  ...
  def mlx_mouse_show(self, mlx_ptr):  # type: ignore
  ...
  def mlx_mouse_move(self, mlx_ptr, x, y):  # type: ignore
...
# API break, returns tuple
  def mlx_mouse_get_pos(self, mlx_ptr):  # type: ignore
    x = c_int()
    y = c_int()
  ...
  def mlx_do_key_autorepeatoff(self, mlx_ptr):  # type: ignore
  ...
  def mlx_do_key_autorepeaton(self, mlx_ptr):  # type: ignore
...
# API break, returns tuple
  def mlx_get_screen_size(self, mlx_ptr):  # type: ignore
    w = c_uint()
    h = c_uint()
...
# Sync funct
  def mlx_do_sync(self, mlx_ptr):  # type: ignore
  ...
  def mlx_sync(self, mlx_ptr, cmd, img_or_win_ptr):  # type: ignore
